            ...
            <div className="flex flex-col gap-[4rem] md:w-[50%]">
              <div className="flex flex-col gap-[1rem]">
                ...
                <p className="font-sofia-regular text-[1.1rem] md:text-[1.2rem] md:font-sofia">
                  ...
                  tailored solutions, catering to a diverse range of industries
                  and needs.
                </p>
              </div>
            </div>
          ...
          <div className="px-[1.5rem] md:px-[4rem] mt-[3rem] md:mt-[6rem] flex flex-col md:flex-row-reverse md:justify-between">
            ...
            <div className="flex flex-col gap-[4rem] md:w-[50%]">
              <div className="flex flex-col gap-[1rem]">
                ...
                <p className="font-sofia-regular text-[1.1rem] md:text-[1.2rem] md:font-sofia">
                  From the outset, our founder, Felix Sunday Ayeniko, envisioned
                  a company that would bridge the gap between businesses and
                  success. With a deep understanding of the challenges faced by
                  enterprises, Felsunny Technology set out to provide top-notch
                  services that drive growth and prosperity.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="px-[1.5rem] md:px-[4rem] mt-[3rem] md:mt-[6rem] flex flex-col md:flex-row">
            ...
            <div className="flex flex-col gap-[4rem] md:w-[50%]">
              <div className="flex flex-col gap-[1rem]">
                ...
                <p className="font-sofia-regular text-[1.1rem] md:text-[1.2rem] md:font-sofia">
                  At Felsunny, we put our clients at the heart of everything we
                  do. By taking the time to understand your unique needs, we
                  ensure our solutions align perfectly with your goals. Our
                  client-focused approach has fostered strong, enduring
                  partnerships that span various sectors and regions. Integrity,
                  innovation, and reliability are not just words for us; they
                  are the pillars of our work. As we continue to evolve and
                  adapt to the ever-changing business landscape, our values
                  remain steadfast.
                </p>
              </div>
            </div>
